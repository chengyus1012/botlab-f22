...
rms_dis = sqrt(mean_squared_error(data4[:,1:3], data3[:,1:3]))
sum = 0
for i in range(data4.shape[0]):
    sum += pow(wrap2Pi(data4[i,3]- data3[i,3]), 2)
rms_heading = sqrt(sum/data4.shape[0])
print(rms_dis, rms_heading)
